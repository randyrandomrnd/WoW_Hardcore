...
local dt_db = {
	...
	{ 389, 2437, "Ragefire Chasm", "D", 5, 1, { 18, 20 },
		...
		{ { "Bazzalan", 11519 }, { "Taramagan the Hungerer", 11520 }, { "Oggleflint", 11517 },
	...
	{ 43, 718, "Wailing Caverns", "D", 5, 1, { 24, 24 },
		...
		{ { "Mutanus", 3654 }, { "Kresh", 3653 }, { "Lady Anacondra", 3671 }, { "Lord Cobrahn", 3669 },
			                                                                                    { "Lord Pythas", 3670 },
			                                                                                                          { "Skum",
				3674 },                                                                                                          { "Lord Serpentis",
			3673 },                                                                                                                                       { "Verdan the Everliving",
			5775 } }
	},
	{ 36, 1581, "The Deadmines", "D", 5, 1, { 26, 24 },
		{ 2040,                   166,               373 }, -- Underground Assault, The Defias Brotherhood, The Unsent Letter
		{ { "Edwin VanCleef", 639 }, { "Rhahk'Zor", 644 }, { "Sneed's Shredder", 642 }, { "Gilnid", 1763 },
			                                                                                        { "Mr. Smite", 646 },
			                                                                                                           { "Captain Greenskin",
				647 },                                                                                                                        { "Cookie",
			645 } }
	...
	{ 33, 209, "Shadowfang Keep", "D", 5, 1, { 30, 25 },
		...
		{ { "Archmage Arugal", 4275 }, { "Rethilgore", 3914 }, { "Razorclaw the Butcher", 3886 },
			                                                                                 { "Baron Silverlaine", 3887 },
			                                                                                                             { "Commander Springvale",
				4278 },                                                                                                                             { "Odo the Blindwatcher",
			4279 },                                                                                                                                                                { "Fenrus the Devourer",
			4274 },                                                                                                                                                                                              { "Wolf Master Nandos",
			3927 } }
	},
	{ 48, 719, "Blackfathom Deeps", "D", 5, 1, { 32, 28 },
		{ 971,              1199,               6565,                   6921,              1200,                  6561,
			                                                                                                                                         6922 }, -- 1198 removed (inside completion)
		{ { "Aku'mai", 4829 }, { "Ghamoo-ra", 4887 }, { "Lady Sarevess", 4831 }, { "Gelihast", 6243 },
			                                                                                   { "Lorgus Jett", 12902 },
	...
	{ 34, 717, "The Stockade", "D", 5, 1, { 32, 29 },
		...
		{ { "Bazil Thredd", 1716 }, { "Targorr the Dread", 1696 }, { "Kam Deepfury", 1666 }, { "Hamhock", 1717 },
			                                                                                              { "Dextren Ward",
				1663 } }
	},
	{ 47, 491, "Razorfen Kraul", "D", 5, 1, { 38, 31 },
		{ 1221,                        1102,            1109,                      1101,                          1142,
			                                                                                                                                     6522 }, -- 1144 removed (inside completion)
		{ { "Charlga Razorflank", 4421 }, { "Roogug", 6168 }, { "Aggem Thorncurse", 4424 },
			                                                                           { "Death Speaker Jargba", 4428 },
			                                                                                                          { "Overlord Ramtusk",
				4420 },                                                                                                                      { "Agathelos the Raging",
			4422 } }
	},
	{ 90, 721, "Gnomeregan", "D", 5, 1, { 38, 32 },
		{ 2904,                           2924,              2930,                     2929,                          2841 }, -- 2945, 2951 removed (inside completion), 2929 removed (outside quest)
		{ { "Mekgineer Thermaplugg", 7800 }, { "Grubbis ", 7361 }, { "Viscous Fallout", 7079 },
	...
	{ 18901, 79601, "Scarlet Monastery (GY)", "D", 5, 1,
		{ 45,                          44 },                      -- Bit of a hack here, the 4 wings don't have a separate ID, so we fake one for them
		{},                                                       -- No quests in GY
	...
	{ 70, 1137, "Uldaman", "D", 5, 1, { 51, 44 },
		...
		{ { "Archaedas", 2748 }, { "Revelosh", 6910 }, { "Ironaya", 7228 }, { "Obsidian Sentinel", 7023 },
			                                                                                       { "Ancient Stone Keeper",
				7206 },                                                                                                       { "Galgann Firehammer",
			7291 },                                                                                                                                        { "Grimlok",
			4854 } }
	},
	{ 209, 1176, "Zul'Farrak", "D", 5, 1, { 54, 50 },
		{ 3042,                           2865,            2846,              2768,                      2770,                          3527,
			                                                                                                                                                           2991,
			                                                                                                                                                                                           2936 },
		{ { "Chief Ukorz Sandscalp", 7267 }, { "Ruuzlu", 7797 }, { "Antu'sul", 8127 }, { "Theka the Martyr", 7272 },
			                                                                                                 { "Witch Doctor Zum'rah",
				7271 },                                                                                                                 { "Nekrum Gutchewer",
			7796 },                                                                                                                                                { "Shadowpriest Sezz'ziz",
			7275 },                                                                                                                                                                                { "Sergeant Bly",
			7604 },                                                                                                                                                                                                       { "Hydromancer Velratha",
			7795 } }
	},
	{ 349, 2100, "Maraudon", "D", 5, 1, { 55, 52 },
		{ 7041,                         7029,              7065,                7064,                      7067 }, -- 7044+7046 removed (inside completion)
		{ { "Princess Theradras", 12201 }, { "Noxxion", 13282 }, { "Razorlash", 12258 }, { "Lord Vyletongue", 12236 },
			                                                                                                   { "Celebras the Cursed",
				12225 },                                                                                                                  { "Landslide",
			12203 },                                                                                                                                           { "Tinkerer Gizlock",
			13601 },                                                                                                                                                                       { "Rotgrip",
			13596 } }
	},
	{ 109, 1477, "The Temple of Atal'Hakkar", "D", 5, 1, { 60, 54 },
		...
		{ { "Shade of Eranikus", 5709 }, { "Atal'alarion", 8580 }, { "Dreamscythe", 5721 }, { "Weaver", 5720 },
			                                                                                            { "Jammal'an the Prophet",
				5710 },                                                                                                             { "Ogom the Wretched",
			5711 },                                                                                                                                             { "Morphaz",
			5719 },                                                                                                                                                               { "Hazzas",
			5722 },                                                                                                                                                                                { "Avatar of Hakkar",
			8443 } }
	},
	{ 229, 1583, "Blackrock Spire", "D", 10, 1, { 60, 62 },
		...
		{ { "General Drakkisath", 10363 }, { "Highlord Omokk", 9196 }, { "Shadow Hunter Vosh'gajin", 9236 },
			{ "War Master Voone", 9237 }, { "Mor Grayhoof", 16080 }, { "Mother Smolderweb", 10596 },
			{ "Urok Doomhowl",      10584 }, { "Quartermaster Zigris", 9736 }, { "Halycon", 10220 },
			{ "Gizrul the Slavener", 10268 }, { "Overlord Wyrmthalak", 9537 },
			{ "Pyroguard Emberseer", 9816 }, { "Solakar Flamewreath", 10264 }, { "Goraluk Anvilcrack", 10899 },
			{ "Warchief Rend Blackhand", 10429 }, { "Gyth", 10339 }, { "The Beast", 10430 }
		}
	}, -- UBRS and LBRS are one instance
	{ 230, 1584, "Blackrock Depths", "D", 5, 1, { 60, 60 },
		{ 4136, 4123, 4286, 4126, 4081, 4134 },
		{ { "Emperor Dagran Thaurissan", 9019 }, { "Lord Roccor", 9025 }, { "Bael'Gar", 9016 },
			{ "Houndmaster Grebmar", 9319 }, { "High Interrogator Gerstahn", 9018 }, { "High Justice Grimstone", 10096 },
			{ "Pyromancer Loregrain",      9024 }, { "General Angerforge", 9033 }, { "Golem Lord Argelmach", 8983 },
			{ "Ribbly Screwspigot", 9543 }, { "Hurley Blackbreath", 9537 }, { "Plugger Spazzring", 9499 },
			{ "Phalanx", 9502 },
			{ "Lord Incendius",     9017 }, { "Fineous Darkvire", 9056 }, { "Warder Stilgiss", 9041 },
			{ "Ambassador Flamelash", 9156 }, { "Magmus", 9938 },
			{ "Princess Moira Bronzebeard", 8929 } }
	},
	{ 289, 2057, "Scholomance", "D", 5, 1, { 60, 62 },
		{ 5529,                         5582,                          5382,                    5384,                 5466,
			                                                                                                                                          5343,
			                                                                                                                                                            5341 },
		{ { "Darkmaster Gandling", 1853 }, { "Kirtonos the Herald", 10506 }, { "Jandice Barov", 10503 },
			                                                                                        { "Rattlegore", 11622 },
			                                                                                                              { "Marduk Blackpool",
				10433 },                                                                                                                          { "Vectus",
			10432 },                                                                                                                                                { "Ras Frostwhisper",
			10508 },                                                                                                                                                                            { "Instructor Malicia",
			10505 },                                                                                                                                                                                                          { "Doctor Theolin Krastinov",
			11261 },                                                                                                                                                                                                                                              { "Lorekeeper Polkelt",
			10901 },                                                                                                                                                                                                                                                                            { "The Ravenian",
			10507 },                                                                                                                                                                                                                                                                                                    { "Lord Alexei Barov",
			10504 },                                                                                                                                                                                                                                                                                                                                 { "Lady Ilucia Barov",
			10502 } }
	},
	{ 429, 2557, "Dire Maul", "D", 5, 1, { 60, 62 },
		{ 7488, 7489, 7441, 5526 }, -- 7461+7462+7703 removed (inside completion)
		{ { "King Gordok", 11501 }, { "Pusillin", 14354 }, { "Lethendris", 14327 }, { "Hydrospawn", 13280 },
			{ "Zevrim Thornhoof", 11490 }, { "Alzzin the Wildshaper", 11492 },
			{ "Guard Mol'dar", 14326 }, { "Stomper Kreeg", 14322 }, { "Guard Fengus", 14321 }, { "Guard Slip'kik", 14323 },
			{ "Captain Kromcrush", 14325 }, { "Cho'Rush the Observer", 14324 },
			{ "Tendris Warpwood", 11489 }, { "Magister Kalendris", 11487 }, { "Tsu'zee", 11467 },
	...
	{ 329, 2017, "Stratholme", "D", 5, 1, { 60, 62 },
		...
		{ { "Baron Rivendare", 10440 },
			{ "Fras Siabi",      11058 }, { "The Unforgiven", 10516 }, { "Postmaster Malown", 11143 },
			{ "Timmy the Cruel", 10808 },
			{ "Malor the Zealous",    11032 }, { "Cannon Master Willey", 10997 }, { "Crimson Hammersmith", 11120 },
			{ "Archivist Galford", 10811 }, { "Balnazzar", 10813 },
			{ "Magistrate Barthilas", 10435 }, { "Nerub'enkan", 10437 }, { "Baroness Anastari", 10436 },
			{ "Maleki the Pallid", 10438 }, { "Ramstein the Gorger", 10439 }
		}
	...
	{ 658, 4813, "Pit of Saron",               "D", 5,  1,    { 1000, 80 },
		                                                                          { 24682, 24683, 24507, 24498, 24712,
			24710, 24713, 24711, 24559, 24461 } },
	-- WotLK raids
...
local function DungeonTrackerPlayerTargetChangedEventHandler(self, event)
	...
	if map_id ~= Hardcore_Character.dt.current.id then
		Hardcore:Debug("Warning: Got a target change to an NPC " ..
		target_name .. " (" .. target_type_id .. ") in wrong dungeon map " .. map_id .. " -- ignoring")
		return
	end
...
local function DungeonTrackerCombatLogEventHandler(self, event)
	...
	-- Do some checks, to eliminate unexpected results
	if map_id ~= Hardcore_Character.dt.current.id then
		Hardcore:Debug("Error: Got a combat log message witn an NPC " ..
		mob_name .. " (" .. mob_type_id .. ") in wrong dungeon map " .. map_id .. " -- bailing out!")
		return
	end
		...
		then
			for j = #Hardcore_Character.dt.runs, i + 1, -1 do
				...
				then
					...
					then
						Hardcore:Debug("Merging dungeon runs with same instance ID in " ..
							Hardcore_Character.dt.runs[i].name .. " of "
	...
	for i = #Hardcore_Character.dt.pending, 1, -1 do
		if Hardcore_Character.dt.pending[i].name == name then
			...
			then
				...
				Hardcore_Character.dt.pending[i].time_inside = Hardcore_Character.dt.pending[i].time_inside +
				Hardcore_Character.dt.current.time_inside
			...
			then
				...
				Hardcore_Character.dt.pending[i].log_now = nil -- clean up
				Hardcore:Debug("Forced logging of pending run in " ..
				Hardcore_Character.dt.pending[i].name .. " with different instance ID")
				DungeonTrackerLogRun(Hardcore_Character.dt.pending[i])
				table.remove(Hardcore_Character.dt.pending, i)
			else
...
function DungeonTrackerHandleAppealCode(args)
	...
	if cmd == "delete" then
		if #quoted_args < 2 then
			...
			if run_found == true then
				...
				local appeal_code = GetDungeonAppealCode(Hardcore_Character.dt.runs[index].name,
	...
	elseif cmd == "merge" then
		if #quoted_args < 3 then
			Hardcore:Print(
			"Wrong syntax: merge cmd should be followed by dungeon name and two date strings (all in quotes)")
